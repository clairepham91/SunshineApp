...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        Log.d(LOG_TAG, "onPerformSync Called. Starting sync");
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, "797e2cb48bcd082f5a237bca67c2e88a")
                    .build();
            ...
            if (Utility.isNoficationAllowed(getContext())) {
                notifyWeather();
            }
        } catch (IOException e) {
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                // Add the back stack to the stack builder by calling addParentStack()
                taskStackBuilder.addParentStack(MainActivity.class); // All parents of MainActivity will be added
                // Add the Intent that starts the Activity from the notification, by calling addNextIntent()
                taskStackBuilder.addNextIntent(resultIntent);
                // If you need to, add arguments to Intent objects on the stack by calling TaskStackBuilder.editIntentAt()

                // Get a PendingIntent for this back stack by calling getPendingIntent(). You can then use this Pending Intent
